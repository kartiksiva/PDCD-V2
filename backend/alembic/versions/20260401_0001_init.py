...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("has_transcript", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        ...
        sa.Column("user_saved_draft", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        ...
        sa.Column("cleanup_pending", sa.Boolean(), nullable=False, server_default=sa.text("false")),
